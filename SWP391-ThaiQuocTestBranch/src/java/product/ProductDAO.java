...
public class ProductDAO {
    ...
    private static final String SEARCH_PRODUCT_BY_NAME = "SELECT [Product].product_id, [Product].product_name, Product.quantity, Product.status, Product.description, Product.capacity, Product.brand, Product.price, i.image,[dbo].[Product].category_id\n"
            + "FROM [dbo].[Product] \n"
            + "Inner Join [dbo].[ProductImage] As i\n"
            + "On Product.product_id = i.product_id\n"
            + "Where product_name like ?";
    private static final String CHECK_DUPLICATE = "SELECT * FROM [dbo].[Product] WHERE  [product_name] like ? ";
